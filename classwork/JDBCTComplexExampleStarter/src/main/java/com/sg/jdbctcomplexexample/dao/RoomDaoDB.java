...
public class RoomDaoDB implements RoomDao {
    ...
    public List<Room> getAllRooms() {
        final String SELECT_ALL_ROOM = "SELECT * FROM room";
        return jdbc.query(SELECT_ALL_ROOM, new RoomMapper());
    }
    ...
    public Room getRoomById(int id) {
        try {
            ...
            final String SELECT_BY_ID = "SELECT * FROM room WHERE id = ?";
            return jdbc.queryForObject(SELECT_BY_ID, new RoomMapper(), id);
    ...
    public Room addRoom(Room room) {
        ...
        int id = jdbc.queryForObject("SELECT currval('room_id_seq')", Integer.class);
        room.setId(id);
        return room;
    }
